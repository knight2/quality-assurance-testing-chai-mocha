...
suite('Unit Tests', function(){
  ...
  suite('Basic Assertions', function() {
    ...
    test('#isDefined, #isUndefined', function(){
      ...
      assert.isUndefined(undefined, 'undefined IS defined');
  ...
  suite('Equality', function() {
    ...
    test('#equal, #notEqual', function(){
      ...
      assert.notEqual({value: 1}, {valie: 1}, '== compares object references');
      assert.equal(6 * '2', '12', 'string times a number is converted into int');
      assert.notEqual(6 + '2', '12', 'string + int, converted into string');
    });
